 ...
 */
final class Version20210328170141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reserver ADD event_id INT NOT NULL, ADD prenom VARCHAR(255) NOT NULL, CHANGE idevent nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reserver ADD idevent VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP event_id, DROP nom, DROP prenom');
    }
}
